...
public:
	...
	*/
	...
	virtual void RenderQuads(const CVertex *pVertices, int PrimCount) = 0;

	virtual void RenderQuadsVertexBuffer(IGraphics::CVertexBufferHandle VertexBuffer, int Offset, int PrimCount) = 0;
